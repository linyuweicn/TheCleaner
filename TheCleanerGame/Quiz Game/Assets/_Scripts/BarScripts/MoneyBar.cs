...
public class MoneyBar : MonoBehaviour
{
	...
	[Range(0, 1f)] public float m_MoneyFillAmount = 0.0f;
	...
	private void Start()
	{
		m_MoneyFillAmount = Score.MoneyValue / 100;
	}
	private void Update()
	{
		for (int i = 0; i < m_NumberOfSegments; i++)
		{
			m_MoneyFillAmount = Score.MoneyValue / 100;
			m_ProgressToFill[i].fillAmount = (m_MoneyFillAmount * ((m_EndAngle - m_StartAngle) / 360)) - m_SizeOfSegment * i;
		}
	}
