...
using TMPro;
using System;
public class OldCensorshipUI : MonoBehaviour
{
    #region variables
    ...
    public void Show()
    {
        ...
        OldGeneralFlowStateManager.instance.answerManager.SetAreAnswersClickable(false);
        OldGeneralFlowStateManager.instance.promptButton.Hide();
    }
    public void Hide()
    {
        for (int i = 0; i < transform.childCount; i++)
        ...
        OldGeneralFlowStateManager.instance.answerManager.SetAreAnswersClickable(true);
        OldGeneralFlowStateManager.instance.promptButton.Show();
    }
    public void SetCensorshipUI(OldAnswer answer)
    {
